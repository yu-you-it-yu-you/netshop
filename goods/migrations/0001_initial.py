# Generated by Django 2.0 on 2020-03-19 03:40
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(on_delete=False, to='goods.Category')),
            ],
        ),
        migrations.CreateModel(
            name='GoodsDetail',
        ...
        migrations.AddField(
            ...
            name='size',
            field=models.ForeignKey(on_delete=False, to='goods.Size'),
        ),
        migrations.AddField(
            model_name='goodsdetail',
            name='gdname',
            field=models.ForeignKey(on_delete=False, to='goods.GoodsDetailName'),
        ),
        migrations.AddField(
            model_name='goodsdetail',
            name='goods',
            field=models.ForeignKey(on_delete=False, to='goods.Goods'),
        ),
    ]
